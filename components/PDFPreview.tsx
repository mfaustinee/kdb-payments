...
export const PDFPreview: React.FC<PDFPreviewProps> = ({ agreement, onClose }) => {
  return (
    <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm z-[200] flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white w-full max-w-4xl shadow-2xl rounded-none my-8 animate-in zoom-in-95 duration-300 relative">
        ...
        <div className="absolute -top-12 right-0 flex space-x-4 print:hidden">
          <button onClick={() => window.print()} className="bg-emerald-600 text-white px-4 py-2 rounded-lg font-bold text-xs flex items-center hover:bg-emerald-700">
        ...
        <div className="p-16 text-slate-900 bg-white min-h-[1056px] print:p-8" id="formal-agreement">
          {/* Header */}
          <div className="flex flex-col items-center text-center mb-10">
            <div className="mb-4">
              <img 
                src="https://www.kdb.go.ke/wp-content/uploads/2021/06/KDB-Logo.png" 
                alt="KDB Logo" 
            ...
            <div className="pt-8 grid grid-cols-2 gap-12">
                ...
                <div className="space-y-2 min-h-[120px]">
                  ...
                  <div className="py-2 h-20 flex items-center">
                    {agreement.officialSignature ? (
                      <img src={agreement.officialSignature} className="max-h-full" alt="KDB Signature" />
                    ) : (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 min-h-[120px]">
                  ...
                  <div className="py-2 h-20 flex items-center">
                    <img src={agreement.clientSignature} className="max-h-full" alt="Operator Signature" />
                  </div>
                </div>
              </div>
            </div>
